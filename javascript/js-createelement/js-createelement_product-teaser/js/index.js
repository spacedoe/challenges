...
<footer class="product__footer">
  ...
  <button type="button" class="product__buy-button" data-js="secondBuyButton">Buy</button>
</footer>`;

document.body.append(article);

const secondBuyButton = document.querySelector('[data-js="secondBuyButton"]');

secondBuyButton.addEventListener("click", () => {
  console.log("secondBuyButton clicked!");
